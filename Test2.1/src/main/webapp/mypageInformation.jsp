...
<body>
	...
	<tr align="left">
		...
		<td><input type="text" style="width:50px;" id="zipNo"  name="zipNo" />
         <button type="button" onClick="goPopup();"> 주소찾기</button></td>
		<td style="padding-left: 2.9em"><td><input type="text"  style="width:300px;" id="address"  name="uAddress" placeholder="${content_view.uAddress}"/></td>
		</tr>
		<tr align="left">
		<td>계좌 :</td> 
		<td>
